...
export function Inputbox({
  ...
  return (
    ...
    >
      <label
        className=" text-white dark:text-lg font-normal mb-2"
        htmlFor={labelname}
      >
        {labelname}
      </label>
      <div className="flex justify-between items-center w-full rounded-md border dark:border-2 text-white">
...
export function PinInputbox({ onChange, type }) {
  return (
    <div className="flex flex-col pt-3 pb-2 w-full">
      ...
      <input
        className="p-2 rounded-md bg-transparent border dark:border-2 border-white text-white focus:outline-none focus:border-blue-500"
        type={type}
        id="pin"
        placeholder="1111"
        onChange={onChange}
